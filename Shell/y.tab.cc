...
{
       0,    53,    53,    57,    58,    61,    74,    78,    79,    84,
      91,    92,    96,    97,   101,   110,   118,   127,   131,   140,
...
static const char *const yytname[] =
{
  ...
  "GREATGREAT", "GREATAMPERSAND", "GREATGREATAMPERSAND", "LESS",
  "AMPERSAND", "PIPE", "TWOGREAT", "$accept", "goal", "commands",
  "command", "command_line", "command_and_args", "argument_list",
  "pipe_list", "argument", "command_word", "iomodifier_opt",
  "iomodifier_list", "background", YY_NULLPTR
};
#endif
